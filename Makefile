...
help:
	...
	@echo "  stats-page   Generate the stats dashboard page"
...
all: scrape addresses geocode distances maps pages webpages stats-page custom-map-data constituent-map
