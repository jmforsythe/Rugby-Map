...
from map_builder import MapConfig, MarkerItem, generate_multi_group_map, load_itl_hierarchy
...
def main() -> None:
    ...
    parser.add_argument(
        "--production",
        action="store_true",
        help="Production mode: output to tier_maps/football/maps/, hide debug layers",
    )
    ...
    geocoded_dir = _SCRIPT_DIR / "geocoded_teams" / season / "BSLFL"
    ...
    if is_prod:
        ...
        output_dir = repo_root / "tier_maps" / "football" / "maps" / season
    else:
